...
Revision ID: c435caacfed5
Revises: 
Create Date: 2024-03-07 03:16:20.665265
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['gallery_id'], ['gallery.id'], name=op.f('fk_reports_gallery_id_gallery')),
