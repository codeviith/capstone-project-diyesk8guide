...
Revision ID: 3f9f8e47a6f5
Revises: 
Create Date: 2024-02-11 20:01:24.503011
...
def upgrade():
    ...
    sa.Column('deck_brand', sa.String(), nullable=False),
    ...
    sa.Column('motor_size', sa.Integer(), nullable=False),
    sa.Column('motor_kv', sa.Integer(), nullable=False),
    sa.Column('motor_power', sa.Integer(), nullable=False),
    sa.Column('wheel_type', sa.String(), nullable=False),
    sa.Column('wheel_size', sa.String(), nullable=False),
    sa.Column('max_speed', sa.Integer(), nullable=False),
    sa.Column('max_range', sa.Integer(), nullable=False),
    sa.Column('other_features', sa.Integer(), nullable=True),
