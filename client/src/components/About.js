...
function About() {
  return (
    <div className="about">
      ...
      <span style={{ whiteSpace: 'pre-wrap' }}>
        Here at DIYesk8Guide, you'll find carefully curated guides and build samples, all supported by an intuitive AI assistant (aka. Guru). Our resources are strategically structured to establish a strong base, leading you step-by-step from initial basics to achieving your first accomplished build.{'\n'}{'\n'}
      </span>
